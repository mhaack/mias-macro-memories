...
export async function getAllMacroImagesWithSlug() {
...
export async function getAllMacroImagesForHome(preview) {
  const data = await fetchAPI(
    `
...
export async function getMacroImageBySlug(slug, preview) {
  const data = await fetchAPI(
    `
